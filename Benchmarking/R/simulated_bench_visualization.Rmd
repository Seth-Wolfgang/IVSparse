...
VCSCResults10 = read.csv("~/results/VCSCResults_0.1.csv")
IVCSCResults10 = read.csv("~/results/IVCSCResults_0.1.csv")
...
triple_plot_ratio_over_eigen_no_legend <- function(dataset1_results, dataset1_name, dataset2_results, dataset2_name, dataset3_results, dataset3_name, eigen1, eigen2, eigen3, y_axis_variable, name) {
  ...
  combined_data <- rbind(
    data.frame(redundancy = eigen_first_data_1$redundancy, ratio = ratio1, dataset = dataset1_name, eigenResult = "eigen1"),
    data.frame(redundancy = eigen_first_data_2$redundancy, ratio = ratio2, dataset = dataset2_name, eigenResult = "eigen2"),
    data.frame(redundancy = eigen_first_data_3$redundancy, ratio = ratio3, dataset = dataset3_name, eigenResult = "eigen3")
  )
...
triple_plot_raw <- function(dataset1_results, dataset1_name, dataset2_results, dataset2_name, dataset3_results, dataset3_name, eigen1, eigen2, eigen3, y_axis_variable, name) {
  ...
  p <- ggplot(combined_data, aes(x = redundancy, y = ratio, color = dataset, shape = dataset)) +
    ...
    scale_color_manual(values = c("#00C058", "#BF00F1", "#0000EE"), labels = c(dataset1_name, dataset2_name, dataset3_name), name = legend_name) +
    scale_shape_manual(values = c(16, 17, 15), labels = c(dataset1_name, dataset2_name, dataset3_name), name = legend_name) +   
    theme(
      legend.direction = "horizontal", 
      legend.text.align = 0.5, 
      legend.position = "bottom", 
...
triple_size_plot <- function(dataset1_results, dataset1_name, dataset2_results, dataset2_name, dataset3_results, dataset3_name, eigenResults1, eigenResults5, eigenResults10, name) {
  ...
  path = paste0("~/vscode/IVSparse-Figures/plots/", name, "/")
  dir.create(file.path(path), showWarnings = FALSE)
  pdf(paste0(path,name,"_",y_axis_variable, ".pdf"),
      width = 6,
      height = 6)
  ...
  ratio3 <-
    dataset3_first_data[[y_axis_variable]] / (16 * thirdNonzero)
  ...
  combined_data <- rbind(
    data.frame(
      redundancy = eigen_first_data_1$redundancy,
      ratio = ratio1,
      dataset = dataset1_name,
      eigenResult = "eigenResults1"
    ),
    data.frame(
      redundancy = eigen_first_data_5$redundancy,
      ratio = ratio2,
      dataset = dataset2_name,
      eigenResult = "eigenResults5"
    ),
    data.frame(
      redundancy = eigen_first_data_10$redundancy,
      ratio = ratio3,
  ...
  combined_data$dataset <-
    factor(combined_data$dataset,
           levels = c(dataset1_name, dataset2_name, dataset3_name))
...
p <- ggplot(combined_data, aes(x = redundancy, y = ratio, color = dataset, shape = dataset)) +
    geom_point() +
    labs(x = "Redundancy",
         y = paste0("Ratio of ", name, " Memory Usage Over COO")) +
    theme_minimal() +
    ...
    scale_y_continuous(breaks = scales::pretty_breaks(n = 10), limits = c(0,1)) + # Set limits to start from 0.1
    scale_x_continuous(breaks = scales::pretty_breaks(n = 5)) +
    scale_color_manual(values = c("#00C058", "#BF00F1", "#0000EE"), labels = c(dataset1_name, dataset2_name, dataset3_name), name = legend_name) +
    scale_shape_manual(values = c(16, 17, 15), labels = c(dataset1_name, dataset2_name, dataset3_name), name = legend_name) +   
    theme(
...
density_triple_size_plot <- function(dataset1_results, dataset1_name, dataset2_results, dataset2_name, dataset3_results, dataset3_name, name) {
  ...
  path = paste0("~/vscode/IVSparse-Figures/plots/", name, "/")
  dir.create(file.path(path), showWarnings = FALSE)
  pdf(paste0(path,name,"_","density_",y_axis_variable, ".pdf"),
      width = 6,
      height = 6)
...
p <- ggplot(combined_data, aes(x = sparsity, y = ratio, color = dataset, linetype = dataset)) +
    ...
    scale_x_continuous(breaks = scales::pretty_breaks(n = 5)) +
    scale_color_manual(values = c("#00C058", "#BF00F1", "#0000EE"), labels = c(dataset1_name, dataset2_name, dataset3_name), name = legend_name) +
    scale_linetype_manual(values = c("solid", "dashed", "dotted"), labels = c(dataset1_name, dataset2_name, dataset3_name), name = legend_name) +   
    theme(
      legend.direction = "horizontal", 
      legend.text.align = 0.5, 
      legend.position = "bottom", 
...
triple_plot <- function(dataset1_results, dataset1_name, dataset2_results, dataset2_name, dataset3_results, dataset3_name, eigenResult, y_axis_variables, name) {
  plots <- list()
  path = paste0("~/vscode/IVSparse-Figures/plots/", name,"/")
  dir.create(file.path(path), showWarnings = FALSE)
  pdf(paste0(path, "combined", ".pdf"),
      width = 15,
      height = 5)
  myManual <- 1
  count <- length(y_axis_variables)
  for (y_axis_variable in y_axis_variables) {
    # Select the first data point for each ID in eigenResult and datasets
    eigen_first_data <- eigenResult %>%
      group_by(ID) %>%
      summarise_at(vars(redundancy, all_of(y_axis_variable)), ~mean(., na.rm = TRUE))
    ...
    # Calculate the ratio by dividing y_axis_variable in each dataset_results by the corresponding values in eigen_first_data
    ratio1 <- dataset1_first_data[[y_axis_variable]] / eigen_first_data[[y_axis_variable]]
    ratio2 <- dataset2_first_data[[y_axis_variable]] / eigen_first_data[[y_axis_variable]]
    ratio3 <- dataset3_first_data[[y_axis_variable]] / eigen_first_data[[y_axis_variable]]

    # Combine the data frames for all three datasets and eigenResult
    combined_data <- rbind(
      data.frame(redundancy = eigen_first_data$redundancy, ratio = ratio1, dataset = dataset1_name, eigenResult = "eigenResult"),
      data.frame(redundancy = eigen_first_data$redundancy, ratio = ratio2, dataset = dataset2_name, eigenResult = "eigenResult"),
      data.frame(redundancy = eigen_first_data$redundancy, ratio = ratio3, dataset = dataset3_name, eigenResult = "eigenResult")
    )
    ...
    # Create the scatter plot for the dataset ratio over Eigen
      ...
      p <- ggplot(combined_data, aes(x = redundancy, y = ratio, color = dataset, shape = dataset)) +
        ...
        theme_minimal() +
        theme(
          axis.title.y = element_text(size = 15),   # Adjust the font size of y-axis text
          axis.title.x = element_text(size = 15),   # Adjust the font size of x-axis text
          axis.text.x = element_text(size = 15),    # Adjust the font size of x-axis tick labels
          axis.text.y = element_text(size = 15),    # Adjust the font size of y-axis tick labels
        ) +
        scale_y_continuous(breaks = scales::pretty_breaks(n = 10)) +
        scale_color_manual(values = c("#00C058", "#BF00F1", "#0000EE"), labels = c(dataset1_name, dataset2_name, dataset3_name), guide = "none") +
        scale_shape_manual(values = c(16, 17, 15), labels = c(dataset1_name, dataset2_name, dataset3_name), guide = "none")
      ...
      myManual <- ggplot(combined_data, aes(x = redundancy, y = ratio, color = dataset, shape = dataset)) +
        ...
        theme_minimal() +
        theme(
          legend.text = element_text(size = 14),    # Adjust the font size of legend labels
          legend.title = element_text(size = 14)    # Adjust the font size of legend title
        ) +
        scale_y_continuous(breaks = scales::pretty_breaks(n = 10)) +
        scale_color_manual(values = c("#00C058", "#BF00F1", "#0000EE"), labels = c(dataset1_name, dataset2_name, dataset3_name), name = "Format") +
        scale_shape_manual(values = c(16, 17, 15), labels = c(dataset1_name, dataset2_name, dataset3_name), name = "Format") +   theme(
    ...
    # Add a label "1.0" on the y-axis at y=1
    if(!grepl("All", name, ignore.case = TRUE)) {
      p <- p + geom_hline(yintercept = 1, color = "blue", linetype = "dashed") 
    }

    plots[[y_axis_variable]] <- p
    count <- count - 1
  }
...
triple_plot(IVCSCResults1, "IVCSC 1% Dense", VCSCResults1, "VCSC 1% Dense", eigenResults1, "Eigen 1% Dense" , eigenResults1, c("scalar_time","spmv_time","spmm_time"),"All_1_density")
triple_plot(IVCSCResults5, "IVCSC 5% Dense", VCSCResults5, "VCSC 5% Dense", eigenResults5, "Eigen 5% Dense" , eigenResults5, c("scalar_time","spmv_time","spmm_time"),"All_5_density")
triple_plot(IVCSCResults10, "IVCSC 10% Dense", VCSCResults10, "VCSC 10% Dense", eigenResults10, "Eigen 10% Dense" , eigenResults10, c("scalar_time","spmv_time","spmm_time"),"All_10_density")
...
triple_size_plot(VCSCResults1, "1%", VCSCResults5, "5%", VCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "VCSC")
triple_plot_ratio_over_eigen_no_legend(VCSCResults1, "1%", VCSCResults5, "5%", VCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "constructor_time", "VCSC")
triple_plot_raw(VCSCResults1, "1%", VCSCResults5, "5%", VCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "constructor_time", "VCSC")
triple_plot_ratio_over_eigen_no_legend(VCSCResults1, "1%", VCSCResults5, "5%", VCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "scalar_time", "VCSC")
triple_plot_ratio_over_eigen_no_legend(VCSCResults1, "1%", VCSCResults5, "5%", VCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "spmv_time", "VCSC")
triple_plot_ratio_over_eigen_no_legend(VCSCResults1, "1%", VCSCResults5, "5%", VCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "spmm_time", "VCSC")
triple_plot_ratio_over_eigen_no_legend(VCSCResults1, "1%", VCSCResults5, "5%", VCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "sum_time", "VCSC")
```

```{R}
triple_size_plot(IVCSCResults1, "1%", IVCSCResults5, "5%", IVCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "IVCSC")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults1, "1%", IVCSCResults5, "5%", IVCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "constructor_time", "IVCSC")
triple_plot_raw(IVCSCResults1, "1%", IVCSCResults5, "5%", IVCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "constructor_time", "IVCSC")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults1, "1%", IVCSCResults5, "5%", IVCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "scalar_time", "IVCSC")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults1, "1%", IVCSCResults5, "5%", IVCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "spmv_time", "IVCSC")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults1, "1%", IVCSCResults5, "5%", IVCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "spmm_time", "IVCSC")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults1, "1%", IVCSCResults5, "5%", IVCSCResults10, "10%", eigenResults1, eigenResults5, eigenResults10, "sum_time", "IVCSC")
...
triple_size_plot(IVCSCResults1, "IVCSC",  VCSCResults1, "VCSC", eigenResults1, "CSC" , eigenResults1, eigenResults1, eigenResults1,"All_1_density")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults1, "IVCSC", VCSCResults1, "VCSC", eigenResults1, "Eigen" ,eigenResults1, eigenResults1, eigenResults1 ,"constructor_time","All_1_density")
triple_plot_raw(IVCSCResults1, "IVCSC", VCSCResults1, "VCSC", eigenResults1, "Eigen" ,eigenResults1, eigenResults1, eigenResults1 ,"constructor_time","All_1_density")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults1, "IVCSC", VCSCResults1, "VCSC", eigenResults1, "Eigen" ,eigenResults1, eigenResults1, eigenResults1 ,"scalar_time","All_1_density")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults1, "IVCSC", VCSCResults1, "VCSC", eigenResults1, "Eigen" ,eigenResults1, eigenResults1, eigenResults1 ,"spmv_time","All_1_density")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults1, "IVCSC", VCSCResults1, "VCSC", eigenResults1, "Eigen" ,eigenResults1, eigenResults1, eigenResults1 ,"spmm_time","All_1_density")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults1, "IVCSC", VCSCResults1, "VCSC", eigenResults1, "Eigen" ,eigenResults1, eigenResults1, eigenResults1 ,"sum_time","All_1_density")
...
```{R}
triple_size_plot(IVCSCResults5, "IVCSC",  VCSCResults5, "VCSC", eigenResults5, "CSC" , eigenResults5, eigenResults5, eigenResults5,"All_5_density")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults5, "IVCSC", VCSCResults5, "VCSC", eigenResults5, "Eigen" ,eigenResults5, eigenResults5, eigenResults5 ,"constructor_time","All_5_density")
triple_plot_raw(IVCSCResults5, "IVCSC", VCSCResults5, "VCSC", eigenResults5, "Eigen" ,eigenResults5, eigenResults5, eigenResults5 ,"constructor_time","All_5_density")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults5, "IVCSC", VCSCResults5, "VCSC", eigenResults5, "Eigen" ,eigenResults5, eigenResults5, eigenResults5 ,"scalar_time","All_5_density")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults5, "IVCSC", VCSCResults5, "VCSC", eigenResults5, "Eigen" ,eigenResults5, eigenResults5, eigenResults5 ,"spmv_time","All_5_density")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults5, "IVCSC", VCSCResults5, "VCSC", eigenResults5, "Eigen" ,eigenResults5, eigenResults5, eigenResults5 ,"spmm_time","All_5_density")
triple_plot_ratio_over_eigen_no_legend(IVCSCResults5, "IVCSC", VCSCResults5, "VCSC", eigenResults5, "Eigen" ,eigenResults5, eigenResults5, eigenResults5 ,"sum_time","All_5_density")
...
# triple_plot_ratio_over_eigen_bottom_legend(IVCSCResults10, "IVCSC", VCSCResults10, "VCSC", eigenResults10, "Eigen" ,eigenResults10, eigenResults10, eigenResults10 ,"spmm_time","All_10_density")
